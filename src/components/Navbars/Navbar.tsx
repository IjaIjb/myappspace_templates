...
const Navbar = () => {
  ...
  return (
    <div>
            ...
            <div className="flex justify-between items-center py-4 gap-4 md:px-[40px] px-3">
              ...
              <div className="flex flex-row font-medium mt-0  space-x-6 text-sm">
                ...
                <div className="flex  space-x-2">
                  ...
                  {
                    // userLoginData?.token ?
                    //     <Tippy hideOnClick={true} trigger="click" theme="light" interactive={true} arrow={false} placement="bottom-end" offset={[0, -10]} triggerTarget={target} content={
                    ...
                    //                 <hr />
                    //                 <li onClick={logOut} className='py-2 cursor-pointer hover:bg-gray-200 px-2'>Logout</li>
                    //             </ul>
                    //         </div>

                    //     }>
                    //         <h3 className='text-[11.6px] font-normal mt-2 cursor-pointer text-white'>Hi, {userLoginData?.data?.first_name}</h3>
                    //     </Tippy>
                    //     :
                    <NavLink to={"/"}>
      ...
      <nav className=" block md:hidden pr-3">
