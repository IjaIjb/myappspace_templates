          ...
          >
            <div class="grid gap-6 mb-6 md:grid-cols-2">
              ...
              <div>
                ...
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Email" />
              </div>
              <div>
                ...
                // onChange={(e) => setPhoneNumber(e?.target?.value)}
                 id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Phone" />
              </div>
              <div>
            ...
            <span className="md:flex md:justify-start mt-4 gap-2">
              <button
                type="submit"
